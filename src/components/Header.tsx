...
const Header = () => {
  ...
  return (
    <div className="bg-gray-950 text-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-gray-950/80 backdrop-blur-md py-4 z-50">
        <nav className="container mx-auto px-4 mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold">Lwazi<span className="text-orange-500">.</span></h1>
