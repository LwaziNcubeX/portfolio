        ...
        <Section id="projects">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, index) => (
              <Card key={index} 
                className="bg-gray-950 border-none overflow-hidden max-w-80 rounded-lg drop=shadow-lg shadow-orange-500/50"
              >
                ...
                <CardContent className="p-4">
                  ...
                  <h3 className="text-orange-500 font-serif font-bold mb-2 text-lg line-clamp-2">{project.title}</h3>
