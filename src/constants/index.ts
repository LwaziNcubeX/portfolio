export const projects = [
  {
    ...
    demoLink: 'https://aquabills.example.com',
    repoLink: 'https://github.com/username/aquabills',
    role: 'Full-Stack Developer',
    features: ['Automated billing', 'Real-time water usage monitoring', 'Invoice generation'],
  },
  {
    id: 2,
    title: "Renomy",
    ...
    technologies: ['Python', 'Telegram API', 'Heroku'],
    demoLink: 'https://t.me/renomybot',
    repoLink: 'https://github.com/username/renomy',
    role: 'Bot Developer',
    features: ['File renaming', 'File compression', 'File transfer automation'],
  },
  {
    id: 3,
    ...
    repoLink: 'https://github.com/username/events-tracker-api',
